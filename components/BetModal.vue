        ...
        <div v-show="selectedTab === 1" class="new-bet">
          <div class="row">
            <div class="column">
              ...
              <input v-model="homeScore" type="number" inputmode="numeric" :readonly="lockInput" min="0" placeholder="0" class="bet-input form-input">
            </div>
            <div class="column">
              <div class="text-center">Away</div>
              <input v-model="awayScore" type="number" inputmode="numeric" :readonly="lockInput" min="0" placeholder="0" class="bet-input form-input">
            </div>
          </div>
        </div>
      </section>
